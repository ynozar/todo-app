...
using ToDoBackend.Domain.Services.Implementations;
...
builder.Services.AddHealthChecks()
    ...
    //.AddDbContextCheck<ApplicationDataContext>("/dbcontext"); //Uses Reflection
...
app.MapGet("/health", () => "Healthy").WithTags("Health");
